...
@Component({
  selector: 'shoppr-monorepo-assign-to-driver',
  templateUrl: './assign-to-driver.page.html',
  styleUrls: ['./assign-to-driver.page.scss'],
})
export class AssignToDriverPage implements OnInit {
  drop: IDrop;
  ...
  confirm() {
    ...
    this.dropService
      .replenishWareshouseStock(this.drop.uuid, newDropItems)
      .subscribe(
        async (ok) => {
